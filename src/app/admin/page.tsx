export const dynamic = 'force-dynamic'; // Obliga a Vercel a actualizar siempre
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white selection:bg-amber-500/30">
      ...
      <section className="relative pt-24 pb-32 px-6 text-center overflow-hidden">
        ...
        <img src="/logo-encuentro.png" alt="Logo" className="w-48 h-48 md:w-64 md:h-64 mx-auto mb-12 drop-shadow-[0_0_30px_rgba(245,158,11,0.3)] animate-in fade-in zoom-in duration-1000" />
      ...
      {/* SECCIÓN SOBRE KARLA (LA FOTO QUE ENVIASTE) */}
      <section className="py-32 bg-slate-900/20 border-y border-white/5 px-6">
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-16">
          <div className="relative group">
            <div className="absolute -inset-4 bg-amber-500/10 rounded-full blur-2xl"></div>
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="inline-block px-8 py-2 bg-amber-500 text-black text-[10px] font-black uppercase rounded-full tracking-widest shadow-lg shadow-amber-500/20">
      ...
      {/* FOOTER CON REDES SOCIALES OFICIALES */}
      <footer className="py-24 bg-slate-950 border-t border-white/5">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-12">
          <div className="text-center md:text-left">
            ...
            <p className="text-slate-600 text-[10px] font-bold mt-2 uppercase tracking-widest">© {new Date().getFullYear()} • Karla Perdomo</p>
          </div>
          
          <div className="flex items-center gap-8">
            <a href="https://www.facebook.com/profile.php?id=100077372310677&sk=reviews" target="_blank" className="bg-slate-900 p-4 rounded-2xl border border-white/5 text-slate-400 hover:text-blue-500 hover:border-blue-500/30 transition-all">
              <Facebook size={24} />
            </a>
            <a href="https://www.youtube.com/@EEncuentro" target="_blank" className="bg-slate-900 p-4 rounded-2xl border border-white/5 text-slate-400 hover:text-red-500 hover:border-red-500/30 transition-all">
              <Youtube size={24} />
            </a>
          </div>
        </div>
