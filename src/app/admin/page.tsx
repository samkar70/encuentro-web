export const dynamic = 'force-dynamic'; // Esta línea mata el caché de Vercel
    ...
    <main className="min-h-screen bg-slate-950 text-white selection:bg-amber-500/30 font-sans">
      ...
      <section className="relative pt-24 pb-32 px-6 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center animate-in fade-in zoom-in duration-1000">
          ...
          <h1 className="text-5xl md:text-8xl font-black bg-gradient-to-b from-white via-white to-slate-500 bg-clip-text text-transparent tracking-tighter uppercase mb-8 leading-tight">
      ...
      <section className="py-32 px-6 bg-slate-900/20 border-y border-white/5">
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-16">
          <div className="w-56 h-56 md:w-72 md:h-72 rounded-full overflow-hidden border-4 border-amber-500/20 shadow-2xl">
          ...
          <div className="text-center md:text-left flex-1">
            ...
            <h2 className="text-3xl md:text-5xl font-black text-white uppercase tracking-tighter mb-6">El Propósito</h2>
            <p className="text-slate-400 text-lg leading-relaxed mb-8 italic">
              "Mi misión es ser un puente de esperanza, llevando un mensaje que restaure corazones."
            </p>
      ...
      <footer className="py-24 bg-slate-950 border-t border-white/5">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-12">
          <div className="text-center md:text-left">
            ...
            <p className="text-slate-600 text-[10px] uppercase font-bold mt-2">© {new Date().getFullYear()} • Karla Perdomo</p>
          </div>
          <div className="flex items-center gap-6">
            <a href="https://www.facebook.com/profile.php?id=100077372310677&sk=reviews" target="_blank" className="bg-slate-900 p-4 rounded-2xl border border-white/5 hover:text-blue-500 transition-all"><Facebook size={24} /></a>
            <a href="https://www.youtube.com/@EEncuentro" target="_blank" className="bg-slate-900 p-4 rounded-2xl border border-white/5 hover:text-red-500 transition-all"><Youtube size={24} /></a>
          </div>
        </div>
      </footer>
    </main>
